alter table if exists public.emails
  ...
  add column if not exists assistant_reply_type text null,
  add column if not exists assistant_reply_subject text null,
  add column if not exists assistant_reply_body text null,
  add column if not exists assistant_reply_disclaimer text null,
  add column if not exists assistant_reply_recipients jsonb null,
  add column if not exists assistant_reply_generated_at timestamptz null,
