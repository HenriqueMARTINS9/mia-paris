          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    <p className="font-semibold tracking-tight">{request.reference}</p>
                    <Badge variant="outline">
                      {channelLabel[request.sourceChannel]}
                    </Badge>
                  </div>
                  <p className="mt-2 line-clamp-2 text-base font-semibold tracking-tight text-foreground">
                ...
                <div className="inline-flex shrink-0 items-center gap-1 rounded-full border border-white/70 bg-white px-2.5 py-1 text-xs font-semibold">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                ...
                <ProductionStageBadge stage={request.productionStage} className="w-fit" />
              </div>
              ...
              <div className="mt-4 grid gap-3 text-sm sm:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="mt-1 font-semibold">{getDeadlineLabel(request.dueAt)}</p>
                  <p className="mt-1 text-muted-foreground">
                ...
                <div>
                  ...
                  <p className="mt-1 font-semibold">{request.owner}</p>
                  <p className="mt-1 text-muted-foreground">{request.ownerRole}</p>
                </div>
                <div>
                  <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                    IA & trace
